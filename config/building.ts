...
export function buildBuilding(yearBuilt?: number): {
  ...
  const checkBody: Localized = {
    en: `${
      asbestos ? "A pre-2002 build can mean asbestos in legacy pipes or elements. " : ""
    ...
    es: `${
      asbestos
        ? "Una construcción anterior a 2002 puede implicar amianto en tuberías o elementos antiguos. "
        : ""
    ...
    ca: `${
      asbestos
        ? "Una construcció anterior al 2002 pot implicar amiant en canonades o elements antics. "
        : ""
