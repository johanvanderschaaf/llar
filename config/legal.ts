...
export function buildLegal(): { intro: Localized; items: Localized[] } {
  return {
    ...
    items: [
      ...
      {
        en: "División horizontal, confirms the flat is a distinct registered unit and its share of the building.",
        es: "División horizontal, confirma que el piso es una unidad registral independiente y su cuota en el edificio.",
        ca: "Divisió horitzontal, confirma que el pis és una unitat registral independent i la seva quota a l'edifici.",
      },
      {
